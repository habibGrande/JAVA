...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Expense Name: <span class="font-weight-normal">${expense.getTitle()}</span></h5>
            <h5 class="card-title">Expense Description: <span class="font-weight-normal">${expense.getDescription()}</span></h5>
            <h5 class="card-title">Vendor: <span class="font-weight-normal">${expense.getVentor()}</span></h5>
